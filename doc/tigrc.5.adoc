...
'side-by-side' (bool)::
	...
	truncated to half of the width. Horizontal scrolling moves both sides
	and 'wrap-lines' does not apply to paired rows. Combined diffs, word
	diffs and the stage view always use the unified layout. Off by
	default.
