...
'diff-highlight' (mixed)::
	...
	The program is run with the `COLORTERM` environment variable cleared
	since colors are rendered with the terminal palette; true colors
	emitted anyway are approximated by the 256-color palette. Regions
